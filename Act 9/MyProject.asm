...
L_main0:
;MyProject.c,11 :: 		PortB = 0b00111111;
	MOVLW      63
	MOVWF      PORTB+0
...
L_main2:
	...
	NOP
	NOP
;MyProject.c,15 :: 		PortB = 0b00000110;
	MOVLW      6
	MOVWF      PORTB+0
...
L_main3:
	...
	NOP
	NOP
;MyProject.c,19 :: 		PortB = 0b01011011;
	MOVLW      91
	MOVWF      PORTB+0
...
L_main4:
	...
	NOP
	NOP
;MyProject.c,23 :: 		PortB = 0b01001111;
	MOVLW      79
	MOVWF      PORTB+0
...
L_main5:
	...
	NOP
	NOP
;MyProject.c,27 :: 		PortB = 0b01100110;
	MOVLW      102
	MOVWF      PORTB+0
...
L_main6:
	...
	NOP
	NOP
;MyProject.c,31 :: 		PortB = 0b01101101;
	MOVLW      109
	MOVWF      PORTB+0
...
L_main7:
	...
	NOP
	NOP
;MyProject.c,35 :: 		PortB = 0b01111101;
	MOVLW      125
	MOVWF      PORTB+0
...
L_main8:
	...
	NOP
	NOP
;MyProject.c,39 :: 		PortB = 0b00000111;
	MOVLW      7
	MOVWF      PORTB+0
...
L_main9:
	...
	NOP
	NOP
;MyProject.c,43 :: 		PortB = 0b01111111;
	MOVLW      127
	MOVWF      PORTB+0
...
L_main10:
	...
	NOP
	NOP
;MyProject.c,47 :: 		PortB = 0b01100111;
	MOVLW      103
	MOVWF      PORTB+0
